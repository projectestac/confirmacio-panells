...
import ca from './missatges_ca.json';
import { replaceText, pluralize } from '../utils';

ca.replace = (key, replacements = {}) => replaceText(ca[key], replacements);
ca.pluralize = (key, count) => pluralize(ca[key], count);
